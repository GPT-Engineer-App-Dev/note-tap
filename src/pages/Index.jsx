...
const Index = () => {
  ...
  return (
    <Container centerContent maxW="container.md" py={10} bg="brand.900" color="brand.50">
      <VStack spacing={4} width="100%">
        ...
        <Box width="100%" mt={10}>
          {notes.map((note, index) => (
            <Box key={index} p={5} shadow="md" borderWidth="1px" borderRadius="md" mb={4} bg="brand.800" color="brand.50">
